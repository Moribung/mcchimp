...
<style>
  ...
  .page-hero::before {
    ...
    position: absolute;
    inset: 0;
    background: radial-gradient(ellipse 50% 60% at 80% 50%, rgba(232,193,74,0.05) 0%, transparent 70%);
    pointer-events: none;
  }
  .page-hero-tag {
  ...
  .engine-desc { font-size: 14px; color: rgba(242,239,232,0.45); line-height: 1.6; }
