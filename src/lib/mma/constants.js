...
export const FIGHTER_ROSTER = [
  { id:'F001', fn:'Jake',    ln:'Torres',   nick:'The Hammer',       nat:'US', style:'Wrestler/GnP',       wRange:[8,18],  lRange:[1,4],  prefixes:['MMA-EA-00','MMA-EA-01','MMA-EA-02'] },
  { id:'F002', fn:'Carlos',  ln:'Santos',   nick:'El Diablo',        nat:'BR', style:'Muay Thai striker',  wRange:[10,22], lRange:[2,6],  prefixes:['MMA-EA-03','MMA-EA-04','MMA-ME-00'] },
  { id:'F003', fn:'Viktor',  ln:'Novak',    nick:'Iron Curtain',     nat:'RU', style:'Sambo/wrestler',     wRange:[12,20], lRange:[1,4],  prefixes:['MMA-ME-01','MMA-ME-02','MMA-ME-03'] },
  { id:'F004', fn:'Danny',   ln:'Reed',     nick:'Lights Out',       nat:'US', style:'Boxer',              wRange:[6,14],  lRange:[2,5],  prefixes:['MMA-ME-04','MMA-ME-05','MMA-HA-00'] },
  { id:'F005', fn:'Manny',   ln:'Rocha',    nick:'The Machine',      nat:'MX', style:'BJJ specialist',     wRange:[9,18],  lRange:[1,3],  prefixes:['MMA-HA-01','MMA-HA-02','MMA-HA-03'] },
  { id:'F006', fn:'Rory',    ln:'Walsh',    nick:'The Ghost',        nat:'IE', style:'Counter-striker',    wRange:[11,21], lRange:[2,5],  prefixes:['MMA-HA-04','MMA-HA-05','MMA-EL-00'] },
  { id:'F007', fn:'Elias',   ln:'Petrov',   nick:'Stone Cold',       nat:'RU', style:'Pressure fighter',   wRange:[14,26], lRange:[1,4],  prefixes:['MMA-EL-01','MMA-EL-02','MMA-EL-03'] },
  { id:'F008', fn:'Andre',   ln:'Okafor',   nick:'The Predator',     nat:'NG', style:'Kickboxer',          wRange:[8,17],  lRange:[3,7],  prefixes:['MMA-EL-04','MMA-EL-05','MMA-EA-05'] },
  { id:'F009', fn:'Liam',    ln:'Murphy',   nick:'Chaos',            nat:'IE', style:'Unorthodox brawler', wRange:[7,15],  lRange:[4,8],  prefixes:['MMA-EA-06','MMA-EA-07','MMA-ME-06'] },
  { id:'F010', fn:'Kosta',   ln:'Diaz',     nick:'The Surgeon',      nat:'RU', style:'Technical striker',  wRange:[13,24], lRange:[1,3],  prefixes:['MMA-ME-07','MMA-ME-08','MMA-ME-09'] },
  { id:'F011', fn:'Finn',    ln:'Steele',   nick:'Razor',            nat:'GB', style:'Submission hunter',  wRange:[10,19], lRange:[2,5],  prefixes:['MMA-HA-06','MMA-HA-07','MMA-HA-08'] },
  { id:'F012', fn:'Omar',    ln:'Garza',    nick:'The Reaper',       nat:'MX', style:'Wrestler/top ctrl',  wRange:[15,28], lRange:[1,4],  prefixes:['MMA-EL-06','MMA-EL-07','MMA-EL-08'] },
  { id:'F013', fn:'Tyler',   ln:'Cross',    nick:'Wildcard',         nat:'US', style:'All-rounder',        wRange:[6,12],  lRange:[3,7],  prefixes:['ANbu-00','ANbu-01','ANbu-02'] },
  { id:'F014', fn:'Serge',   ln:'Ferreira', nick:'The Cobra',        nat:'BR', style:'Clinch specialist',  wRange:[9,16],  lRange:[2,6],  prefixes:['ANbu-03','ANbu-04','ANme-00'] },
  { id:'F015', fn:'Niko',    ln:'Bell',     nick:'Silent Storm',     nat:'US', style:'Karate/counter',     wRange:[11,20], lRange:[1,4],  prefixes:['ANme-01','ANme-02','ANme-03'] },
  { id:'F016', fn:'Brent',   ln:'Kim',      nick:'The Natural',      nat:'KR', style:'MMA all-rounder',    wRange:[8,15],  lRange:[3,6],  prefixes:['ANme-04','ANme-05','ANme-06'] },
  { id:'F017', fn:'Joel',    ln:'Pierce',   nick:'The Technician',   nat:'US', style:'BJJ/wrestling',      wRange:[12,22], lRange:[2,5],  prefixes:['ANha-00','ANha-01','ANha-02'] },
  { id:'F018', fn:'Chase',   ln:'Vance',    nick:'El Fuego',         nat:'US', style:'Volume striker',     wRange:[10,18], lRange:[2,6],  prefixes:['ANha-03','ANha-04','ANha-05'] },
  { id:'F019', fn:'Shane',   ln:'Hayden',   nick:'The Philosopher',  nat:'GB', style:'Grappling wizard',   wRange:[14,25], lRange:[1,3],  prefixes:['ANel-00','ANel-01','ANel-02'] },
  { id:'F020', fn:'Cruz',    ln:'Tran',     nick:'The Ironman',      nat:'US', style:'High-cardio brawler',wRange:[9,17],  lRange:[3,7],  prefixes:['ANel-03','ANel-04','ANel-05'] },
];
