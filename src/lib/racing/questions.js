/**
 * Racing question pool management.
 * Mirrors the golf questions.js pattern: the chosen gear sets a target tier,
 * and the answer's score ratio decides whether you complete the overtake.
 */
 ...
 */
export function selectQuestion(pool, qScores, qUsed, targetTier) {
  const buckets = {};
